...
def homepage(r):
    ...
    libraries = Package.objects.has_latest().libraries().active().sort_recently_active()[:settings.HOMEPAGE_PACKAGES_NUMBER]
    addons = Package.objects.has_latest().addons().active().sort_recently_active()[:addons_limit]
